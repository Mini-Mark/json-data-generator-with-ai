...
def getAnswer():
    ...
    result_data = f"Generate more list of json data with this json:\n{json_data}\n\nPlease generate with the same key and random data from your idea. if data have many than one make it to list []. Give me only JSON. Don't tell anything without JSON"
...
json_label = tk.Label(
    root, text="JSON Data (Ex. Pokemon, {json text}, Person) :")
